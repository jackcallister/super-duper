	  ...
	  render: function() {
	    return (
	      React.createElement("section", {className: "app"}, 
	        React.createElement(MealPicker, {onMealSelect: this.didSelectMeal, meals: this.state.meals}), 
	...
	var MealPicker = React.createClass({displayName: 'MealPicker',
	  ...
	  render: function() {
	    ...
	    this.props.meals.forEach(function(meal, index) {
	      mealButtons.push(React.createElement(MealButton, {onSelect: this.didSelectMeal.bind(this, index), name: meal.name, key: index}))
	    }.bind(this));
	...
	var MealForm = React.createClass({displayName: 'MealForm',
	  ...
	  render: function() {
	    ...
	    var ingredientFields = this.state.ingredients.map(function(ingredient, index) {
	      ...
	      if (isLastField) {
	        addButton = React.createElement("button", {onClick: t.addIngredientField, disabled: t.state.disableIngredientButton}, "Add ingredient");
	    ...
	    return (
	      React.createElement("div", null, 
	        React.createElement("div", {id: "modal-overlay", className: visibleKlass, onClick: this.didToggle}), 
	        React.createElement("div", {ref: "modal", id: "modal", className: visibleKlass}, 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MealButton = React.createClass({displayName: 'MealButton',
	  ...
	  render: function() {
	    return (
	      React.createElement("div", {className: "meal-button-wrapper", onClick: this.props.onSelect}, 
	        React.createElement("div", {className: "meal-button-bar"}), 
	        React.createElement("div", {className: "meal-button"}, 
